...
### <a id="§-2a"></a>§ 3. Zasady etyczne i konflikt interesów
1. Osoby podejmujące decyzje finansowe w imieniu Samorządu, w szczególności członkowie Zarządu i Skarbnik, są zobowiązane do ujawnienia potencjalnych konfliktów interesów i wyłączenia się z podejmowania decyzji w sprawach, których konflikt dotyczy.
2. Zabrania się zawierania umów z podmiotami, w których członkowie Zarządu lub Komisji Rewizyjno-Wyborczej, ich małżonkowie, krewni lub powinowaci do drugiego stopnia posiadają istotny interes majątkowy, chyba że zachowane zostaną procedury konkurencyjne i decyzja zostanie poprzedzona opinią Komisji Rewizyjno-Wyborczej.
3. Zasady dotyczące przyjmowania korzyści majątkowych i prezentów określa [Kodeks Etyczny](03-kodeks-etyczny.md).

## DZIAŁ II. BUDŻET SAMORZĄDU

### <a id="§-3"></a>§ 4. Projekt budżetu
...
### <a id="§-4a"></a>§ 6. Jawność budżetu i sprawozdań
...
### <a id="§-6c"></a><a id="§-11"></a>§ 11. Zakaz zadłużania i limity
1. Samorząd nie może zaciągać zobowiązań wykraczających poza przyjęty Budżet oraz nie może zaciągać pożyczek, kredytów ani leasingu bez uprzedniej zgody Parlamentu wyrażonej większością 2/3 głosów oraz zgody właściwych organów Uczelni.
...
### <a id="§-7a"></a><a id="§-13"></a>§ 13. Rejestr umów
...
### <a id="§-7b"></a><a id="§-14"></a>§ 14. Majątek i inwentaryzacja
...
### <a id="§-9a"></a><a id="§-17"></a>§ 17. Odpowiedzialność i retencja
1. Osoby naruszające postanowienia niniejszego Regulaminu lub dopuszczające do niegospodarności ponoszą odpowiedzialność zgodnie z przepisami wewnętrznymi Uczelni oraz powszechnie obowiązującymi, a także odpowiedzialność dyscyplinarną wewnątrz Samorządu.
2. Dokumentacja finansowa Samorządu (budżet, sprawozdania, umowy, faktury, protokoły kontroli) jest przechowywana przez okres co najmniej 5 lat, chyba że przepisy Uczelni przewidują dłuższy termin.
3. KRW informuje właściwe organy Uczelni o stwierdzonych rażących naruszeniach mogących rodzić odpowiedzialność prawną.
